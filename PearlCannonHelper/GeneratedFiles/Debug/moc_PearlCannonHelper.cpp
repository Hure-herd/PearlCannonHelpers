...
QT_MOC_LITERAL(6, 133, 33), // "on_settingTableWidget_cellCli..."
QT_MOC_LITERAL(7, 167, 26), // "on_applyPushButton_pressed"
QT_MOC_LITERAL(8, 194, 38), // "on_rotationComboBox_currentTe..."
QT_MOC_LITERAL(9, 233, 13), // "generateTrace"
QT_MOC_LITERAL(10, 247, 13), // "updateSetting"
QT_MOC_LITERAL(11, 261, 15), // "updatePearlInfo"
QT_MOC_LITERAL(12, 277, 9), // "updateAll"
QT_MOC_LITERAL(13, 287, 13), // "tryLoadBitSeq"
QT_MOC_LITERAL(14, 301, 16) // "sortSettingTable"

    },
    "PearlCannonHelper\0on_copyBitPushButton_clicked\0"
    "\0on_pasteBitPushButton_clicked\0"
    "on_genPushButton_clicked\0"
    "on_languageComboBox_activated\0"
    "on_settingTableWidget_cellClicked\0"
    "on_applyPushButton_pressed\0"
    "on_rotationComboBox_currentTextChanged\0"
    "generateTrace\0updateSetting\0updatePearlInfo\0"
    "updateAll\0tryLoadBitSeq\0sortSettingTable"
};
...
void PearlCannonHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->on_rotationComboBox_currentTextChanged(); break;
        case 7: _t->generateTrace(); break;
        case 8: _t->updateSetting(); break;
        case 9: _t->updatePearlInfo(); break;
        case 10: _t->updateAll(); break;
        case 11: _t->tryLoadBitSeq((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 12: _t->sortSettingTable((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
